...
var Pen = function () {
    ...
    _createClass(Pen, [{
        ...
        value: function _init() {
            ...
            var titleCrumbs = function titleCrumbs() {
                var title = $('.Pen-title');
                var parts = title.attr('data-path').split('/');
                var start = parts.indexOf('components') + 1;
                var component = parts.pop().replace('.slim', '');
                var path = parts.slice(start);
                var paths = path.map(function (str) {
